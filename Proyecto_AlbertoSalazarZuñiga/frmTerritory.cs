...
namespace Proyecto_AlbertoSalazarZuñiga
{
    public partial class frmTerritory : Form
    {
        ...
        {
            consulta = "EXEC SELECT_Territory '" + frmHome1.manejadorr2 + "'," + idUser;
        ...
        private void InsertarRegistros()
        {
            ...
            {
                frmHome1.contarid("SELECT COUNT(*) FROM [POSTGRESQL]...Territory");
                idSujeto = frmHome1.count;
            }
            consulta = "EXEC INSERT_Territory  '" + frmHome1.manejadorr2 + "','" + name + "'";
        ...
        private void ActualizarRegistros()
        {
            ...
            consulta = "EXEC UPDATE_Territory '" +
        ...
        private void Eliminar(int id)
        {
            ...
            consulta = "EXEC DELETE_Territory '" + frmHome1.manejadorr2 + "','" + id + "'";
